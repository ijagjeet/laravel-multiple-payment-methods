                                ...
                                <div class="form-group" id="toggler">
                                    ...
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        @foreach ($paymentPlatforms as $paymentPlatform)
                                            ...
                                            >
                                                {{--using a radio button because the user should be able select only one at a time --}}
                                                <input type="radio"
                                    ...
                                    @foreach ($paymentPlatforms as $paymentPlatform)
                                        <div
                                            ...
                                            data-parent="#toggler"
                                        >
                                            {{--we should be able to, let's say, show to the user an additional set of fields to input
                                            the card details,the number, the security code, the expiration date --}}
